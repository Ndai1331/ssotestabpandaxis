...
namespace HCS.DocumentService.Migrations
{
    ...
    [Migration("20260827024350_OptimizeDocumentSigningQueries")]
    partial class OptimizeDocumentSigningQueries
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HCS.DocumentService.Documents.DocumentAssignment", b =>
                {
                    ...
                    b.HasIndex("AssigneeUserId", "IsCurrent", "Responsibility", "StepCode");
            ...
            modelBuilder.Entity("HCS.DocumentService.Documents.DocumentHistory", b =>
                {
                    ...
                    b.HasIndex("ActorUserId", "Action", "DocumentId");
            ...
            modelBuilder.Entity("HCS.DocumentService.Workflows.ApprovalTask", b =>
                {
                    ...
                    b.HasIndex("AssigneeUserId", "Status", "InstanceId");
