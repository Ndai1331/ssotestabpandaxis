...
namespace HCS.Migrations
{
    ...
    [Migration("20260804095716_AddPlatformAuditProjectionAndEvents")]
    partial class AddPlatformAuditProjectionAndEvents
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HCS.Auditing.AuditRecordProjection", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("EntityChangesJson")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasIndex("SourceService", "ActionName");
            ...
            modelBuilder.Entity("HCS.Localization.Language", b =>
                {
                    ...
                    b.ToTable("HcsLanguages", (string)null);
                });

            modelBuilder.Entity("HCS.Localization.LanguageText", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ResourceName", "CultureName", "Name")
                        .IsUnique();

                    b.ToTable("HcsLanguageTexts", (string)null);
                });
