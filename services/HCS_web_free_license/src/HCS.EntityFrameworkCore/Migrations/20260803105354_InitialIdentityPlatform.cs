...
{
    /// <inheritdoc />
    public partial class InitialIdentityPlatform : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HcsLanguages", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "HcsLanguageTexts",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HcsLanguageTexts", x => x.Id);
                });
