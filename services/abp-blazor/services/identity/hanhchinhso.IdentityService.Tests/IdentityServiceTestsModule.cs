...
namespace hanhchinhso.IdentityService.Tests;

/* This project has a dotnet project reference to the hanhchinhso.IdentityService project,
 * but it does not have a module dependency to the hanhchinhsoIdentityServiceModule module class.
 * Because, hanhchinhsoIdentityServiceModule has configurations proper for development and production
 ...
 *
 * For example, hanhchinhsoIdentityServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change hanhchinhsoIdentityServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(hanhchinhsoIdentityServiceModule))]
