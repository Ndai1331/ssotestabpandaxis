...
using abptestwithsso.IdentityService.Data;
using Volo.Abp;
...
namespace abptestwithsso.IdentityService.Tests;

/* This project has a dotnet project reference to the abptestwithsso.IdentityService project,
 * but it does not have a module dependency to the abptestwithssoIdentityServiceModule module class.
 * Because, abptestwithssoIdentityServiceModule has configurations proper for development and production
 ...
 *
 * For example, abptestwithssoIdentityServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change abptestwithssoIdentityServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(abptestwithssoIdentityServiceModule))]
