...
using abptestwithsso.IdentityService.HealthChecks;

namespace abptestwithsso.IdentityService;
...
public class abptestwithssoIdentityServiceModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<abptestwithssoIdentityServiceModule>();
        });
    }
    ...
    private void ConfigureAutoControllers()
    {
        Configure<AbpAspNetCoreMvcOptions>(options =>
        {
            options
                ...
                .Create(typeof(abptestwithssoIdentityServiceModule).Assembly, opts =>
                {
