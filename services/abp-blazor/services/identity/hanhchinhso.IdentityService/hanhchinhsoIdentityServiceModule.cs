...
using hanhchinhso.IdentityService.HealthChecks;

namespace hanhchinhso.IdentityService;
...
public class hanhchinhsoIdentityServiceModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<hanhchinhsoIdentityServiceModule>();
        });
    }
    ...
    private void ConfigureAutoControllers()
    {
        Configure<AbpAspNetCoreMvcOptions>(options =>
        {
            options
                ...
                .Create(typeof(hanhchinhsoIdentityServiceModule).Assembly, opts =>
                {
