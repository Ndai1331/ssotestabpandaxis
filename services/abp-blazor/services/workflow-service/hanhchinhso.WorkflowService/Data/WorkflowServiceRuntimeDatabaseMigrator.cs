...
public class WorkflowServiceRuntimeDatabaseMigrator : EfCoreRuntimeDatabaseMigratorBase<WorkflowServiceDbContext>
{
    private readonly WorkflowServiceDataSeeder _dataSeeder;

    public WorkflowServiceRuntimeDatabaseMigrator(
