...
using hanhchinhso.LanguageService.Data;
using Prometheus;
...
using Volo.Abp.LanguageManagement.EntityFrameworkCore;
using hanhchinhso.LanguageService.HealthChecks;
...
public class hanhchinhsoLanguageServiceModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem(ServiceConfigurationContext context)
    {
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            ...
            {
                options.FileSets.ReplaceEmbeddedByPhysical<hanhchinhsoLanguageServiceContractsModule>(
                    Path.Combine(
                        hostingEnvironment.ContentRootPath,
                        string.Format(
                            "..{0}hanhchinhso.LanguageService.Contracts",
        ...
        Configure<AbpVirtualFileSystemOptions>(options =>
        {
            options.FileSets.AddEmbedded<hanhchinhsoLanguageServiceModule>();
        });
    }
    ...
    private void ConfigureAutoControllers()
    {
        Configure<AbpAspNetCoreMvcOptions>(options =>
        {
            options
                ...
                .Create(typeof(hanhchinhsoLanguageServiceModule).Assembly, opts =>
                {
