...
namespace hanhchinhso.LanguageService.Tests;

/* This project has a dotnet project reference to the hanhchinhso.LanguageService project,
 * but it does not have a module dependency to the hanhchinhsoLanguageServiceModule module class.
 * Because, hanhchinhsoLanguageServiceModule has configurations proper for development and production
 ...
 *
 * For example, hanhchinhsoLanguageServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change hanhchinhsoLanguageServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(hanhchinhsoLanguageServiceModule))]
