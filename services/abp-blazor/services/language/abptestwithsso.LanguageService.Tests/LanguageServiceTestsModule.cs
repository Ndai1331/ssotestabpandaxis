...
namespace abptestwithsso.LanguageService.Tests;

/* This project has a dotnet project reference to the abptestwithsso.LanguageService project,
 * but it does not have a module dependency to the abptestwithssoLanguageServiceModule module class.
 * Because, abptestwithssoLanguageServiceModule has configurations proper for development and production
 ...
 *
 * For example, abptestwithssoLanguageServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change abptestwithssoLanguageServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(abptestwithssoLanguageServiceModule))]
public class LanguageServiceTestsModule : AbpModule
{
    ...
    public override async Task OnPreApplicationInitializationAsync(ApplicationInitializationContext context)
    {
        ...
        await scope.ServiceProvider
            .GetRequiredService<LanguageServiceDataSeeder>()
            .SeedAsync();
    }
    ...
    private static SqliteConnection CreateDatabaseAndGetConnection()
    {
        ...
        // LanguageServiceDbContext ()
        new LanguageServiceDbContext(
            new DbContextOptionsBuilder<LanguageServiceDbContext>().UseSqlite(connection).Options
