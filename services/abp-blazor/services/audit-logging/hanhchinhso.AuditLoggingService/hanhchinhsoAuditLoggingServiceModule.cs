...
using hanhchinhso.AuditLoggingService.HealthChecks;
using Prometheus;
...
public class hanhchinhsoAuditLoggingServiceModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<hanhchinhsoAuditLoggingServiceModule>();
        });
    }
    ...
    private void ConfigureAutoControllers()
    {
        Configure<AbpAspNetCoreMvcOptions>(options =>
        {
            options
                ...
                .Create(typeof(hanhchinhsoAuditLoggingServiceModule).Assembly, opts =>
                {
