...
using abptestwithsso.AuditLoggingService.Data;
using Volo.Abp;
...
namespace abptestwithsso.AuditLoggingService.Tests;

/* This project has a dotnet project reference to the abptestwithsso.AuditLoggingService project,
 * but it does not have a module dependency to the abptestwithssoAuditLoggingServiceModule module class.
 * Because, abptestwithssoAuditLoggingServiceModule has configurations proper for development and production
 ...
 *
 * For example, abptestwithssoAuditLoggingServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change abptestwithssoAuditLoggingServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(abptestwithssoAuditLoggingServiceModule))]
public class AuditLoggingServiceTestsModule : AbpModule
{
    ...
    public override async Task OnPreApplicationInitializationAsync(ApplicationInitializationContext context)
    {
        ...
        await scope.ServiceProvider
            .GetRequiredService<AuditLoggingServiceDataSeeder>()
            .SeedAsync();
    }
    ...
    private void ConfigureDatabase(ServiceConfigurationContext context)
    {
        ...
        context.Services.AddAbpDbContext<AuditLoggingServiceDbContext>(options =>
        {
    ...
    private static SqliteConnection CreateDatabaseAndGetConnection()
    {
        ...
        // AuditLoggingServiceDbContext ()
        new AuditLoggingServiceDbContext(
            new DbContextOptionsBuilder<AuditLoggingServiceDbContext>().UseSqlite(connection).Options
