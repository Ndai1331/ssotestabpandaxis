...
using hanhchinhso.AuditLoggingService.Data;
using Volo.Abp;
...
namespace hanhchinhso.AuditLoggingService.Tests;

/* This project has a dotnet project reference to the hanhchinhso.AuditLoggingService project,
 * but it does not have a module dependency to the hanhchinhsoAuditLoggingServiceModule module class.
 * Because, hanhchinhsoAuditLoggingServiceModule has configurations proper for development and production
 ...
 *
 * For example, hanhchinhsoAuditLoggingServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change hanhchinhsoAuditLoggingServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(hanhchinhsoAuditLoggingServiceModule))]
