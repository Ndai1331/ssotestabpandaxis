...
namespace hanhchinhso.OrganizationService.Migrations
{
    ...
    [Migration("20260724104503_EnforceSinglePrimaryDepartment")]
    partial class EnforceSinglePrimaryDepartment
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("hanhchinhso.OrganizationService.Organization.UserDepartment", b =>
                {
                    ...
                    b.HasIndex("UserId")
                        .IsUnique()
                        .HasFilter("\"TenantId\" IS NULL AND \"IsPrimary\" = true AND \"IsDeleted\" = false");
                    ...
                    b.HasIndex("TenantId", "UserId")
                        .IsUnique()
                        .HasFilter("\"TenantId\" IS NOT NULL AND \"IsPrimary\" = true AND \"IsDeleted\" = false");
