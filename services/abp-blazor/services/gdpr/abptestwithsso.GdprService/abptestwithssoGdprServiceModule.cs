...
using abptestwithsso.GdprService.HealthChecks;

namespace abptestwithsso.GdprService;
...
public class abptestwithssoGdprServiceModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<abptestwithssoGdprServiceModule>();
        });
    }
    ...
    private void ConfigureAutoControllers()
    {
        Configure<AbpAspNetCoreMvcOptions>(options =>
        {
            options
                ...
                .Create(typeof(abptestwithssoGdprServiceModule).Assembly, opts =>
                {
