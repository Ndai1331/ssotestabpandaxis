...
using hanhchinhso.GdprService.Data;
using Volo.Abp;
...
namespace hanhchinhso.GdprService.Tests;

/* This project has a dotnet project reference to the hanhchinhso.GdprService project,
 * but it does not have a module dependency to the hanhchinhsoGdprServiceModule module class.
 * Because, hanhchinhsoGdprServiceModule has configurations proper for development and production
 ...
 *
 * For example, hanhchinhsoGdprServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change hanhchinhsoGdprServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(hanhchinhsoGdprServiceModule))]
