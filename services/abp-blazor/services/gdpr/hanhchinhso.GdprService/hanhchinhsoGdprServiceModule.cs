...
using hanhchinhso.GdprService.HealthChecks;

namespace hanhchinhso.GdprService;
...
public class hanhchinhsoGdprServiceModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<hanhchinhsoGdprServiceModule>();
        });
    }
    ...
    private void ConfigureAutoControllers()
    {
        Configure<AbpAspNetCoreMvcOptions>(options =>
        {
            options
                ...
                .Create(typeof(hanhchinhsoGdprServiceModule).Assembly, opts =>
                {
