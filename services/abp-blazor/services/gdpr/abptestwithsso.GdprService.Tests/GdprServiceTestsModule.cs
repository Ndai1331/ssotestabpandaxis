...
using abptestwithsso.GdprService.Data;
using Volo.Abp;
...
namespace abptestwithsso.GdprService.Tests;

/* This project has a dotnet project reference to the abptestwithsso.GdprService project,
 * but it does not have a module dependency to the abptestwithssoGdprServiceModule module class.
 * Because, abptestwithssoGdprServiceModule has configurations proper for development and production
 ...
 *
 * For example, abptestwithssoGdprServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change abptestwithssoGdprServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(abptestwithssoGdprServiceModule))]
public class GdprServiceTestsModule : AbpModule
{
    ...
    public override async Task OnPreApplicationInitializationAsync(ApplicationInitializationContext context)
    {
        ...
        await scope.ServiceProvider
            .GetRequiredService<GdprServiceDataSeeder>()
            .SeedAsync();
    }
    ...
    private static SqliteConnection CreateDatabaseAndGetConnection()
    {
        ...
        // GdprServiceDbContext ()
        new GdprServiceDbContext(
            new DbContextOptionsBuilder<GdprServiceDbContext>().UseSqlite(connection).Options
