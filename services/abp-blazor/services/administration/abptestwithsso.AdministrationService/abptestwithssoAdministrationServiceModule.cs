...
using abptestwithsso.AdministrationService.HealthChecks;
...
public class abptestwithssoAdministrationServiceModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<abptestwithssoAdministrationServiceModule>();
        });
    }
        ...
        Configure<AbpDbContextOptions>(options =>
        {
            ...
            options.Configure<BlobStoringDbContext>(c =>
            {
                c.UseNpgsql(b =>
                {
                    ...
                    b.MigrationsAssembly(typeof(abptestwithssoAdministrationServiceModule).Assembly.GetName().Name);
                });
            });
        });
    ...
    private void ConfigureAutoControllers()
    {
        Configure<AbpAspNetCoreMvcOptions>(options =>
        {
            options
                ...
                .Create(typeof(abptestwithssoAdministrationServiceModule).Assembly, opts =>
                {
