...
using abptestwithsso.AdministrationService.Data;
using Volo.Abp;
...
namespace abptestwithsso.AdministrationService.Tests;

/* This project has a dotnet project reference to the abptestwithsso.AdministrationService project,
 * but it does not have a module dependency to the abptestwithssoAdministrationServiceModule module class.
 * Because, abptestwithssoAdministrationServiceModule has configurations proper for development and production
 ...
 *
 * For example, abptestwithssoAdministrationServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change abptestwithssoAdministrationServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(abptestwithssoAdministrationServiceModule))]
