...
public class hanhchinhsoAdministrationServiceModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<hanhchinhsoAdministrationServiceModule>();
        });
    }
        ...
        Configure<AbpDbContextOptions>(options =>
        {
            ...
            options.Configure<BlobStoringDbContext>(c =>
            {
                c.UseNpgsql(b =>
                {
                    ...
                    b.MigrationsAssembly(typeof(hanhchinhsoAdministrationServiceModule).Assembly.GetName().Name);
                });
            });
        });
    ...
    private void ConfigureAutoControllers()
    {
        Configure<AbpAspNetCoreMvcOptions>(options =>
        {
            options
                ...
                .Create(typeof(hanhchinhsoAdministrationServiceModule).Assembly, opts =>
                {
