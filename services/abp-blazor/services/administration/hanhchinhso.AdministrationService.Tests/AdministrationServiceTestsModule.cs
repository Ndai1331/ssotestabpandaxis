...
using hanhchinhso.AdministrationService.Data;
using Volo.Abp;
...
namespace hanhchinhso.AdministrationService.Tests;

/* This project has a dotnet project reference to the hanhchinhso.AdministrationService project,
 * but it does not have a module dependency to the hanhchinhsoAdministrationServiceModule module class.
 * Because, hanhchinhsoAdministrationServiceModule has configurations proper for development and production
 ...
 *
 * For example, hanhchinhsoAdministrationServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change hanhchinhsoAdministrationServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(hanhchinhsoAdministrationServiceModule))]
