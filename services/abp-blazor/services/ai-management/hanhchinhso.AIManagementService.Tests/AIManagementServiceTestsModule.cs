...
namespace hanhchinhso.AIManagementService.Tests;

/* This project has a dotnet project reference to the hanhchinhso.AIManagementService project,
 * but it does not have a module dependency to the hanhchinhsoAIManagementServiceModule module class.
 * Because, hanhchinhsoAIManagementServiceModule has configurations proper for development and production
 ...
 *
 * For example, hanhchinhsoAIManagementServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change hanhchinhsoAIManagementServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(hanhchinhsoAIManagementServiceModule))]
