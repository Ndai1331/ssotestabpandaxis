...
using hanhchinhso.AIManagementService.HealthChecks;
...
public class hanhchinhsoAIManagementServiceModule : AbpModule
{
    ...
    private void ConfigureVirtualFileSystem()
    {
        ...
        {
            options.FileSets.AddEmbedded<hanhchinhsoAIManagementServiceModule>();
        });
    }
    ...
    private void ConfigureAutoControllers()
    {
        Configure<AbpAspNetCoreMvcOptions>(options =>
        {
            options
                ...
                .Create(typeof(hanhchinhsoAIManagementServiceModule).Assembly, opts =>
                {
