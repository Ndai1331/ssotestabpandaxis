...
public abstract class AIManagementServiceIntegrationTestBase : AbpWebApplicationFactoryIntegratedTest<TestProgram>
{
    ...
    {
        var assemblyDirectoryPath = Path.GetDirectoryName(typeof(abptestwithssoAIManagementServiceModule).Assembly.Location);
        if (assemblyDirectoryPath == null)
        {
            throw new Exception($"Could not find location of {typeof(abptestwithssoAIManagementServiceModule).Assembly.FullName} assembly!");
        }
