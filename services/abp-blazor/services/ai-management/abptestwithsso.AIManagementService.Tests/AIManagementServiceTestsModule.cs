...
namespace abptestwithsso.AIManagementService.Tests;

/* This project has a dotnet project reference to the abptestwithsso.AIManagementService project,
 * but it does not have a module dependency to the abptestwithssoAIManagementServiceModule module class.
 * Because, abptestwithssoAIManagementServiceModule has configurations proper for development and production
 ...
 *
 * For example, abptestwithssoAIManagementServiceModule depends on AbpEventBusRabbitMqModule,
 ...
 *
 * WARNING: If you change abptestwithssoAIManagementServiceModule class, you may need to properly change this class to keep
...
[AdditionalAssembly(typeof(abptestwithssoAIManagementServiceModule))]
public class AIManagementServiceTestsModule : AbpModule
{
    ...
    public override async Task OnPreApplicationInitializationAsync(ApplicationInitializationContext context)
    {
        ...
        await scope.ServiceProvider
            .GetRequiredService<AIManagementServiceDataSeeder>()
            .SeedAsync();
    }
    ...
    private static SqliteConnection CreateDatabaseAndGetConnection()
    {
        ...
        // AIManagementServiceDbContext ()
        new AIManagementServiceDbContext(
            new DbContextOptionsBuilder<AIManagementServiceDbContext>().UseSqlite(connection).Options
