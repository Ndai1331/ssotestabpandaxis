...
using abptestwithsso.AIManagementService.Localization;
...
public class abptestwithssoAIManagementServiceContractsModule : AbpModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        Configure<AbpVirtualFileSystemOptions>(options =>
        {
            options.FileSets.AddEmbedded<abptestwithssoAIManagementServiceContractsModule>();
        });
