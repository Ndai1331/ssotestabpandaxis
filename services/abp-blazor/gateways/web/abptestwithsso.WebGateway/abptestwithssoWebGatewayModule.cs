...
using abptestwithsso.WebGateway.HealthChecks;
using Microsoft.AspNetCore.Diagnostics.HealthChecks;

namespace abptestwithsso.WebGateway;
...
public class abptestwithssoWebGatewayModule : AbpModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        var configuration = context.Services.GetConfiguration();

        ConfigureStudio(context);
    ...
    private void ConfigureStudio(ServiceConfigurationContext context)
    {
