...
namespace abptestwithsso.WebGateway.HealthChecks;
...
public static class HealthChecksBuilderExtensions
{
    public static void AddWebGatewayHealthChecks(this IServiceCollection services)
    {
        ...
        {
            settings.AddHealthCheckEndpoint("WebGateway Health Status", configuration["App:HealthUiCheckUrl"] ?? healthCheckUrl);
        });
